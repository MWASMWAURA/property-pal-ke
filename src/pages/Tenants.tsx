...
import { Search, Filter, Plus, MessageCircle, Phone } from "lucide-react";
import { tenants, formatKsh } from "@/lib/mock-data";
import { StatusPill } from "./Dashboard";

const Tenants = () => (
  <AppShell title="Tenants" subtitle={`${tenants.length} active tenants across 4 properties`}>
    <Card className="p-4 mb-4 shadow-card border-border/60 flex flex-col sm:flex-row gap-3">
      ...
      <Button className="gradient-primary text-primary-foreground"><Plus className="size-4"/> Add Tenant</Button>
    </Card>
